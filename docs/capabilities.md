...
| **Print** a message from the same overflow menu: the subject and the From, To, Cc and date lines above the body, through the platform's own print dialog, loading remote images only if the reader already did ([docs](docs/reading-actions.md)) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
