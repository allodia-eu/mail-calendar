...
| A message too wide to reflow (a fixed 600px newsletter) is **scaled down to fit** rather than cut off at the right edge; every other pane scrolls sideways instead, no other engine offering the fit without script in the message or a resampled picture of it ([docs](docs/reading-zoom.md)) | ✅ | — | — | — | ✅ | — |
