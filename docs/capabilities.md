...
| Select several messages at once and act on the lot: archive, trash, delete permanently, mark read/unread, flag/unflag. Ctrl/⌘-click and Shift-click on a computer, long-press on a phone; **Delete** trashes the selection and **Escape** clears it where the list has focus ([docs](docs/list-selection.md)) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
