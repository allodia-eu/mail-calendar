...
| New-mail notifications: local, and they say who it is from, what it is about and how it begins, from the background sync. Clicking one **opens that message**. On the desktop only mail that arrives **while the app is open**: the catch-up sync a launch begins with is already on screen, so it is not announced | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
