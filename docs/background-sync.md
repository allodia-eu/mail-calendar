...
| Content | n/a | sender · subject · snippet, as the toast's three text elements | sender · subject and snippet sharing the portal's one body | sender · subject collapsed, the snippet on the expanded `BigTextStyle` | sender · account subtitle · subject and snippet sharing the body |
