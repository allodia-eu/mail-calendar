...
> backoff, since the outage it was waiting out has just ended. Apple, Windows and Linux ship the
> row, the list and the three actions; Android queues and drains but does not draw it yet
