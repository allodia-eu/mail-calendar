...
Search is now centred at the top of the window, and New Mail has moved up there with it. Sync sits beside Archive and Delete, and on iPhone and iPad you pull the list down to sync. Your accounts' inboxes are now one "All Accounts" group you can open and shut.
...
A pesquisa aparece agora centrada no topo da janela, e Nova mensagem subiu para lá com ela. Sincronizar fica junto de Arquivar e Eliminar, e no iPhone e no iPad arrasta a lista para baixo para sincronizar. As caixas de entrada das suas contas formam agora um grupo "Todas as contas" que pode abrir e fechar.
...
```
Search is now centred at the top of the window, and New Mail has moved up there with it. Sync sits beside Archive and Delete. Your accounts' inboxes are now one "All Accounts" group you can open and shut.
...
```
Zoeken staat nu gecentreerd bovenaan het venster, en Nieuwe e-mail is meeverhuisd naar boven. Synchroniseren staat naast Archiveren en Verwijderen. De postvakken IN van je accounts vormen nu één groep "Alle accounts" die je kunt openen en sluiten.
...
```
Die Suche steht jetzt zentriert am oberen Fensterrand, und Neue E-Mail ist mit nach oben gewandert. Synchronisieren sitzt neben Archivieren und Löschen. Die Posteingänge Ihrer Konten bilden jetzt eine Gruppe "Alle Konten", die Sie öffnen und schließen können.
...
```
La recherche est désormais centrée en haut de la fenêtre, et Nouveau message l'y a rejointe. Synchroniser se trouve à côté d'Archiver et de Supprimer. Les boîtes de réception de vos comptes forment désormais un groupe « Tous les comptes » que vous pouvez ouvrir et fermer.
...
```
La búsqueda aparece ahora centrada en la parte superior de la ventana, y Nuevo correo se ha trasladado allí con ella. Sincronizar está junto a Archivar y Eliminar. Las bandejas de entrada de tus cuentas forman ahora un grupo "Todas las cuentas" que puedes abrir y cerrar.
...
```
La ricerca è ora centrata in cima alla finestra, e Nuovo messaggio si è spostato lassù con lei. Sincronizza si trova accanto ad Archivia ed Elimina. Le caselle di posta in arrivo dei tuoi account formano ora un gruppo "Tutti gli account" che puoi aprire e chiudere.
...
```
A pesquisa aparece agora centrada no topo da janela, e Nova mensagem subiu para lá com ela. Sincronizar fica junto de Arquivar e Eliminar. As caixas de entrada das suas contas formam agora um grupo "Todas as contas" que pode abrir e fechar.
